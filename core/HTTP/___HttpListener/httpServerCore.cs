...
namespace host
{
    ...
    //    static void Main()
    //    {
    //        using (HttpServerMultithreading srvr = new HttpServerMultithreading(5))
    //        {
    //            srvr.Start(8085);
    ...
    class httpServerCore : IDisposable
    {
        ...
        public httpServerCore(int maxThreads)
        {
            ...
            // This listener does not want to receive exceptions that occur when sending the response to the client.
